...
struct sPlayer {
	...
	void npcMovement(std::vector<sPlayer*> enemies, std::vector<EntityMesh*> entities,sPlayer* player, float seconds_elapsed, Mesh& playerHP_quad, bool quad, int position, EntityMesh* boss = NULL);
